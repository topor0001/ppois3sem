...
def set_menu():
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                new_set = Set.from_string(string_repr)
                sets.append(new_set)
...
def main():
    ...
    print("  • Interactive testing through menu with manual input")
    print("  • Support for different element types in sets (strings, numbers, nested sets)")
    print("="*60)
